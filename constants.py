...
UNARY_NIL_OPERATORS = []
BINARY_OPERATORS = BINARY_INT_OPERATORS + BINARY_BOOL_OPERATORS + BINARY_STRING_OPERATORS + BINARY_NIL_OPERATORS
COMPARISON_OPERATORS = COMPARISON_INT_OPERATORS + COMPARISON_BOOL_OPERATORS + COMPARISON_STRING_OPERATORS + COMPARISON_NIL_OPERATORS
UNARY_OPERATORS = UNARY_INT_OPERATORS + UNARY_BOOL_OPERATORS + UNARY_STRING_OPERATORS + UNARY_NIL_OPERATORS
OPERATORS = BINARY_OPERATORS + UNARY_OPERATORS + COMPARISON_OPERATORS
COMPARISON_OPERATORS_MIXED_TYPES = [EQUALS, NOT_EQUALS]
COMPARISON_OPERATORS_NOT_MIXED_TYPES = [LESS_THAN, LESS_THAN_EQUALS, GREATER_THAN, GREATER_THAN_EQUALS]
OPERAND_1 = "op1"
OPERAND_2 = "op2"
ARGS = "args"
INPUTI = "inputi"
